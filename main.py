...
if __name__ == '__main__':
    ...
    b_true = tk.Button(root, compound='left', text="No Symbol (N)", command=no_symbol_callback)
    b_false = tk.Button(root, compound='right', text="Symbol (Y)", command=symbol_callback)
